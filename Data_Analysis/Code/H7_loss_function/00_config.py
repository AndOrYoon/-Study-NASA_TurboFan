...
RESULT_DIR = r"C:\BMAD_PY313\Data_Analysis\Results\H7_loss_function"
...
SEEDS   = [0, 1, 2, 3, 4]
WINDOW  = 30          # look-back window for LSTM / linear features
VAL_FRAC = 0.20       # last 20 % of each engine's cycles → validation
...
LAMBDA_DYN   = 1.0    # L3 DynMSE
GAMMA_FOCAL  = 2.0    # L4 Focal
LAMBDA_T     = 1.0    # L5 TWA time weight
LAMBDA_A     = 2.0    # L5/L7 asymmetry
TAU_PINBALL  = 0.35   # L6 Pinball
DELTA_HUBA   = 20.0   # L7 HubA
LAMBDA_A_HUBA = 2.0   # L7 HubA asymmetry
