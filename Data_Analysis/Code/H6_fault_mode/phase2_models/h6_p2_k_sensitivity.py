...
Results saved to Data_Analysis/Results/H6_fault_mode/k_sensitivity/
"""
...
RESULTS_DIR = Path(__file__).parent.parent.parent.parent / "Results" / "H6_fault_mode" / "k_sensitivity"
