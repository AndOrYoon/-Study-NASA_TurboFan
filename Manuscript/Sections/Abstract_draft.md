...
> **Draft status:** v1.3 — 2026-07-30 (T6 gate confidence 결론 문장 통합; "flight cycles" → "cycles" 1단어 압축)
...
| Item | Detail |
|------|--------|
| Word count | ~201 words (RESS limit: 200; trim "NASA Score by 98.8%" or "BH-FDR" if needed) |
