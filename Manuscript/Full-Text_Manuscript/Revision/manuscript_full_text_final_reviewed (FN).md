...
- 2 MINOR formatting tasks: (1) remove revision metadata block (lines ~17-18), (2) fix Section II numbering gap and duplicated heading in source
- 1 MAJOR content task: add N1/N3 four-dataset comparison table with mean±SD, ΔRMSE, effect size, raw p, p_BH (§IV.B)
-->
...
<!-- REVIEW — MAJOR
Add a compact table with N1/N3 mean±SD, ΔRMSE, effect size, raw p, and p_BH for all four datasets. The 40-run robustness analysis is not fully auditable from prose alone.
-->
