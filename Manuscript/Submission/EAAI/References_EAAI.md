...
### New Additions — Literature Strengthening (2026-09-23)

**[46] Shi, X., Peng, T., Liu, C., & Xu, C. (2024)**
"A dual attention LSTM lightweight model based on exponential smoothing for remaining useful life prediction."
*Reliability Engineering & System Safety*, Vol. 243, Article 109821, 2024 (156 citations).
**Used in:** §II.A (bundling example — dual attention + exp. smoothing combined without ablation)
**Note:** Highly cited recent RESS paper that bundles multiple novel components (dual attention, exponential smoothing, lightweight LSTM) into a single system. RMSE improvements reported across all four CMAPSS sub-datasets. Direct exemplar of the attribution problem: individual component contributions not isolable. tex key: ref50.

---

**[47] Freitas, A., Figueiredo, G., & Werneck, F. (2026)**
"A Statistical Analysis of the State-of-the-Art Transformer-Based Remaining Useful Life Models on C-MAPSS FD001."
*arXiv preprint*, 2026.
**Used in:** §II.A (reproducibility motivation), §II.E Gap 1
**Note:** Controlled 30-run reproducibility study of 21 Transformer-based FD001 models. Key result: AGATT (originally reported RMSE = 11.45) reproduced as 15.99 ± 1.39 under repeated execution — demonstrating that single-seed RMSE values systematically underrepresent central tendency. Directly motivates this study's 5-seed repeated design and BH-FDR correction. tex key: ref51.

---

**[48] Ruvaifa, M., Anisetti, M., & Damiani, E. (2026)**
"Evaluating the impact of data preprocessing on deep neural architectures for Remaining Useful Life estimation of turbofan engines."
*Array*, 2026.
**Used in:** §II.B (closest prior preprocessing ablation), §II.E Gap 3
**Note:** Most systematic preprocessing comparison available at submission time — evaluates sensor screening, sequence-length design, and normalisation choices across all four CMAPSS sub-datasets. Finds preprocessing impact exceeds architectural complexity in many configurations. Gap vs. this study: no pairwise significance testing between normalisation strategies, no BH-FDR correction, does not isolate op-condition × normalisation interaction on FD002/FD004, and does not evaluate the seven discrete reference-statistic choices examined here. tex key: ref52.

---

**[49] Xiong, Z., Chang, Y., Guo, X., & Zhang, B. (2023)**
"Adaptive deep learning-based remaining useful life prediction framework for systems with multiple failure patterns."
*Reliability Engineering & System Safety*, Vol. 235, Article 109244, 2023 (67 citations).
**Used in:** §II.C (adaptive FM-aware RUL framework)
**Note:** Proposes a physics-informed fault-mode classifier integrated with DCNN and operating-condition-aware smoothing; reports ~7% RUL accuracy improvement on CMAPSS multi-fault sub-datasets vs. single-branch baseline. Gap vs. H6: routing accuracy and smoothing contributions not isolated; no controlled backbone-matched comparison; no hard/soft routing boundary evaluation. tex key: ref53.
...
**[54] Ochella, S., Shafiee, M., & Dinmohammadi, F. (2022)**
"Artificial intelligence in prognostics and health management of engineering systems."
*Engineering Applications of Artificial Intelligence*, Vol. 108, Article 104552, 2022 (173 citations).
DOI: 10.1016/j.engappai.2021.104552
**Used in:** Background (§I / §II.A)
**Note:** Comprehensive EAAI review of AI/ML methods for PHM — model-driven, data-driven, and hybrid approaches; covers RUL prediction, fault detection, anomaly detection across engineering systems. Cited to position this study within the broader AI-for-PHM landscape. **Target journal citation** — directly supports EAAI submission. tex key: ref54.
